...
// ==== Quiz Logic ==== 
const meshNames = [
    'anatomical_neck', 'surgical_neck', 'greater_tubercle 1', 'lesser_tubercle',
    'head', 'deltoid_tuberosity 1', 'trochlea', 'capitulum',
    'medial_epicondyle', 'lateral_epicondyle', 'intertubercular_sulcus',
    'olecranon_fossa', 'radial_fossa 2', 'coronoid_fossa 2'
];
